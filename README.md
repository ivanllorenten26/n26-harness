...
### 2. Install all harness plugins

```bash
/plugin install harness-init@n26-harness
/plugin install harness-pdr@n26-harness
/plugin install harness-plan@n26-harness
/plugin install harness-implement@n26-harness
